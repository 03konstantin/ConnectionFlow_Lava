          ...
          <div className="receipt">
            ...
            <div className="r-section">
              <div className="r-section-title">
                {/* Heart Icon */}
                <img src={heartIcon} alt="Heart" width="24" height="24" style={{ marginRight: '8px', verticalAlign: 'middle' }} />
                キノアウ パートナー
              </div>
            ...
            {matchedStudents.surprising && (
              <>
                <div className="r-section">
                  <div className="r-section-title">
                    {/* Target Icon */}
                    <img src={targetIcon} alt="Target" width="24" height="24" style={{ marginRight: '8px', verticalAlign: 'middle' }} />
                    オドロキヲ アタエル パートナー
                  </div>
